# Japan Readiness Audit - Send Ready Report

## Objective

Prepare the first 5 LinkedIn DMs for execution as soon as the Google Form URL is available.
...
Use this link when a prospect replies positively and asks to see the sample.

## 3. DM Send Targets

Send to the top 5 companies from `TARGET_10_COMPANIES.md`.

| Send Order | Company | URL | Industry | Country |
|---:|---|---|---|---|
| 1 | Petite Skin Co. | https://www.petiteskinco.com | Skincare / DTC | Australia |
| 2 | Daeskin Global | https://www.daeskinglobal.com | K-beauty / Skincare | South Korea / Global |
| 3 | DEVATA Jewelry | https://devata.com | Jewelry / Shopify DTC | United States |
| 4 | EVE Oslo | https://evestore.com | Jewelry / Fashion accessories | Norway |
| 5 | The AllureK | https://theallurek.com | K-beauty / Skincare retail | United States / Global |
...
### Timing objection: "Japan is not a priority"
...
|---|---|
| "We already ship internationally" | Explain that shipping is only one part; buyer readiness also includes trust, FAQ, duties, returns, support, and hesitation points. |
| "We can use AI for this" | Emphasize website-specific Japanese buyer perspective and priority-ranked fixes. |
| "Does this guarantee sales?" | Say no clearly; it identifies readiness gaps before spending on Japan launch activity. |
| "Why $49?" | Explain it is Founder Beta pricing for the first 10 slots. |
| "Who prepares this?" | Say it is prepared by Nexora Studio JP, a Japan-based business lab focused on buyer-readiness for overseas small businesses. |
...
Sales are not the objective of this batch.
